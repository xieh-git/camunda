...
final class ElasticsearchConnectorIT {
  @Container
  ...
  public static void setSearchPluginProperties(final DynamicPropertyRegistry registry)
    ...
    registry.add(TasklistProperties.PREFIX + ".elasticsearch.url", wireMockServer::baseUrl);
    registry.add(TasklistProperties.PREFIX + ".zeebeElasticsearch.url", wireMockServer::baseUrl);
  }
