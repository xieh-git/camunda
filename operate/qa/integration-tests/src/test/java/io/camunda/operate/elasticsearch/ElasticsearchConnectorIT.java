...
public class ElasticsearchConnectorIT {
  ...
  public static void setSearchPluginProperties(final DynamicPropertyRegistry registry)
    ...
    registry.add(OperateProperties.PREFIX + ".elasticsearch.url", wireMockServer::baseUrl);
    registry.add(OperateProperties.PREFIX + ".zeebeElasticsearch.url", wireMockServer::baseUrl);
  }
