...
public class OpensearchConnector {
  ...
  public OpensearchConnector(
    ...
    osPluginRepository =
        new PluginRepository().load(operateProperties.getOpensearch().getPlugins());
    zeebeOsPluginRepository =
        new PluginRepository().load(operateProperties.getZeebeOpensearch().getPlugins());
  }
  ...
  public OpenSearchClient openSearchClient() {
    final OpenSearchClient openSearchClient =
        createOsClient(operateProperties.getOpensearch(), osPluginRepository);
    try {
  ...
  public OpenSearchAsyncClient openSearchAsyncClient() {
    final OpenSearchAsyncClient openSearchClient =
        createAsyncOsClient(operateProperties.getOpensearch(), zeebeOsPluginRepository);
  ...
  public OpenSearchClient zeebeOpensearchClient() {
    ...
    return createOsClient(operateProperties.getZeebeOpensearch(), zeebeOsPluginRepository);
  }

  public OpenSearchAsyncClient createAsyncOsClient(
      final OpensearchProperties osConfig, final PluginRepository osPluginRepository) {
    ...
    builder.setHttpClientConfigCallback(
        httpClientBuilder -> {
          configureHttpClient(httpClientBuilder, osConfig, osPluginRepository);
  ...
  public OpenSearchClient createOsClient(
    ...
    builder.setHttpClientConfigCallback(
        httpClientBuilder -> {
          configureHttpClient(httpClientBuilder, osConfig, pluginRepository);
          return httpClientBuilder;
        });
